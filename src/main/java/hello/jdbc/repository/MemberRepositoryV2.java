...
public class MemberRepositoryV2 {
    ...
    @Autowired
    public MemberRepositoryV2(DataSource dataSource) {      //주입을 받았다.
    ...
    public Member findById(Connection con,String memberId) throws SQLException {
        ...
        try{
            //con = getConnection();      //이거 지워야돼  호출하면 큰일나  완전 새로운 커넥션임
            pstmt = con.prepareStatement(sql);
            ...
            //JdbcUtils.closeConnection(con);       //서비스에서 커넥션을 넘겨줄텐데, 이제 커넥션을 닫는 결정은 서비스에서 종료해야된다.
        }
    }
